...
///   dotnet build TestTarget/Profiler/TestTarget.csproj -c Debug -p:EnableDiagnostics=true -t:Install -p:AdbTarget="-s emulator-5556"
...
public class SessionTests
{
    ...
    public async Task Build_time_weaving_session_uses_the_build_map()
    {
        string map = Environment.GetEnvironmentVariable("NAP_WEAVE_MAP")
            ?? Path.Combine(RepoRoot(), "TestTarget", "Profiler", "bin", "Debug", "net10.0-android", "nap-weave.map");
