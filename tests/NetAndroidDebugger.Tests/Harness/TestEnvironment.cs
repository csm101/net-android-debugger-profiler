...
public static class TestEnvironment
{
    ...
    public static string TestTargetProject => Path.Combine(RepoRoot, "TestTarget", "Debugger", "TestTarget.csproj");
    public static string TestTargetDir => Path.Combine(RepoRoot, "TestTarget", "Debugger");
