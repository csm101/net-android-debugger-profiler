...
assert.throws(
    ...
    (err) => err.message.includes("definitely-not-here.dll") && err.message.includes("register-mcp-debugger.cmd"),
...
assert.throws(
    ...
    "the default location is the one register-mcp-debugger.cmd publishes to");
